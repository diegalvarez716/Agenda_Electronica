...
public class InterfazFiltrarApellido {
    JPanel panel = new JPanel();
    JTable tabla = new JTable();
    DefaultTableModel modelo = new DefaultTableModel();
    JScrollPane scrollPane;
    public InterfazFiltrarApellido(String dato){
        JFrame frame = new JFrame("Filtrar por Apellido");
        ...
        while (aux!= null){
            if (aux.apellido.equalsIgnoreCase(dato)){
